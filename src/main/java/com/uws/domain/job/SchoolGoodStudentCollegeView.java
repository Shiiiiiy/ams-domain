...
/**
 * @className SchoolGoodStudentCollegeView.java
 * @package com.uws.domain.job
 * @description 校优秀毕业生按学院统计视图
 * @date 2015-11-16  下午5:48:55
 */
public class SchoolGoodStudentCollegeView implements Serializable {
	private static final long serialVersionUID = -5026638816419451305L;
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		SchoolGoodStudentCollegeView other = (SchoolGoodStudentCollegeView) obj;
		if (college == null) {
